...
describe('FileSsystemDatasource', () => {
    ...
    test('should a save log in logs-all.log', () => {
    ...
    test('should a save log in logs-all.log and logs-medium.log', () => {
    ...
    test('should a save log in logs-all.log and logs-high.log', () => {
    ...
    test('should throw an error if severity level is not defined', async() => {
        ...
        try {
            ...
            expect(errorString).toContain(`${ customSeverityLevel } not implement`);
